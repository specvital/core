...
func TestParseFunctionName(t *testing.T) {
	...
	// parseFunctionName is an internal function, tested indirectly through parse
	tests := []struct {
		name       string
		source     string
...
func TestExtractTestName(t *testing.T) {
	...
	// extractTestName is an internal function, tested indirectly through parse
	tests := []struct {
		name   string
		source string
		want   string
...
func TestFindCallback(t *testing.T) {
	...
	// findCallback is an internal function, tested indirectly through parse
	tests := []struct {
		name       string
		source     string
		wantSuites int
...
func TestExtractEachTestCases(t *testing.T) {
	...
	// extractEachTestCases is an internal function, tested indirectly through parse
	tests := []struct {
		name      string
		source    string
		wantCount int
